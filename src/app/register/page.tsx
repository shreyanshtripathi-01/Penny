      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative z-10 py-8">
        <div className="w-full max-w-[360px] bg-[#f5f5f2] border border-[#030213]">
          ...
          <div className="p-6 border-b border-[#030213] text-center">
            ...
            <h1 className="text-lg font-bold uppercase tracking-widest">System Registration</h1>
          </div>
          ...
          <div className="p-6">
            ...
            <form className="space-y-6">
              <div>
                <label htmlFor="fullName" className="block text-xs font-mono font-bold uppercase tracking-widest text-[#030213] mb-2">
                  Legal Name
                </label>
                <input
                  id="fullName"
