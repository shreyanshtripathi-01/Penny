      ...
      <div className="flex-1 flex items-center justify-center px-6 pb-24">
        <div className="w-full max-w-[360px]">
          <div className="mb-8">
            ...
            <h1 className="text-[24px] font-bold text-[#030213] tracking-tight mb-2">Create an account</h1>
            <p className="text-[14px] text-[#717182] font-medium">Start tracking your finances today.</p>
          </div>
          ...
          <form className="space-y-4">
            <div>
              <label htmlFor="fullName" className="block text-[13px] font-semibold text-[#030213] mb-1.5">
                Full name
              </label>
              <input
                id="fullName"
          ...
          <p className="mt-8 text-center text-[13px] text-[#717182] font-medium">
            ...
            <Link href="/login" className="text-[#030213] hover:underline font-semibold">
              Log in
            </Link>
          </p>
        </div>
